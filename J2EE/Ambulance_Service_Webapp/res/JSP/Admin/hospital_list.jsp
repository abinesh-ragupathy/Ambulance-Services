...
<section id="content">
<form name="myForm" action="<%=request.getContextPath()%>/HospitalCreation">	
...
<div style="position: relative;top: -15px;left: 325px;">
	...
	<input type="submit" name="action" value="Add Hospital"  id="button" style="width:100px; "/>&nbsp;&nbsp;
		<input type="submit" name="action" value="Edit Hospital" id="button" style="width:100px; "/>
	
	<input type="submit" name="action" value="Delete Hospital" id="button" style="width:100px; "/>
</div>
...
%>
		<div class="success" id="message" style="position:absolute;top:421px;left:11px">	
			<p>Hospital Details Deleted Successfully.....!</p>
		</div>			
<%
	}
...
%>
		<div class="success" id="message" style="position:absolute;top:421px;left:11px">	
			<p>Hospital Details Updated Successfully....!</p>
		</div>			
<%
	}
