...
<%
	...
	if(rs != null)
	{
		...
		{
			code = rs.getInt(1);
			ambulance_loc_name = rs.getString(2);
...
<section id="content" style="position: absolute;top:15;left:190px;">
	...
	<h1>Update Ambulance Details</h1>
	<table style="width: 500px;text-align: center;">
		
		<tr align="center">
	        <td>
	        		ambulance_loc_name<font color="red" size="4">*</font>
	        </td>
	        
	        <td width="11px">:</td>
	        
			<td>
					<input type="text" name="ambulance_loc_name"  value="<%=ambulance_loc_name%>" class="easyui-validatebox" required="required" autofocus required  title="Please,Enter The Land Mark."/>
			</td>
		...
		<tr align="center">
			...
			<td>
			        <%--
			        		...
			        		Example : -85.123456
			         --%>
					<input type="text" name="latitude" value="<%=latitude%>" class="easyui-validatebox" required="required"  title="Please,Enter The Valid Latitude(x-axis)."/>
			</td>
		...
		<tr align="center">
			...
			<td>
			        <%--
			        		...
			        		Example : -100.123456
			         --%>
					<input type="text" name="logitude" value="<%=logitude%>" class="easyui-validatebox"  required="required"   title="Please,Enter The Valid Longitude(y-axis)."/>
			</td>
		...
		<tr align="center">
				<td colspan="3" align="center">
						<input type="submit" name="action" value="edit" style="left: 201px;"/>
