...
<html>
<head>
<title>Add Police Station Details</title>
...
--%>
	...
	<form name="frm" action="<%=request.getContextPath()%>/Ambulance" method="get">
			
	<h1>Ambulance</h1>
	<table style="width: 500px;text-align: center;">
		<tr align="center">
	        <td>
	        		Ambulance Locations Name:<font color="red" size="4">*</font>
	        </td>
	        
	        <td width="11px">:</td>
	        
			<td>
				<input type="text" name="ambulance_loc_name"  placeholder="Enter The Ambulance Location Name" class="easyui-validatebox"   required="required" title="Please,Enter The Police station name."/>
			</td>
		...
		<tr align="center">
				<td colspan="3" align="center">
						<input  type="submit" name="action" value="Add Ambulance" style="left:190px;width: 150px;"/>
...
%>
		<div class="error" id="message" style="position:absolute;top:421px;left:11px">	
			<p>Sorry,This Police Station Already Exists!!!!!</p>
		</div>			
<%
	}
%>
