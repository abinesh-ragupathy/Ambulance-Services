...
<% String Hospital_name="",Address1="",Address2="",Area="",city="",state="",pin="",land_line="",cell_no1="",remarks="",latitude="",logitude=""; %>
 <%
	int i=1;
 ResultSet rs=AdminDAO.getHospital();
	...
	<table style="width: 500px;text-align: center;">
		...
		<tr align="center">
				<td colspan="3" align="center">
						<input  type="submit" name="action" value="Delete Hospital" style="left:190px;width: 150px;"/>
						<input  type="hidden" name="delete" value="YES" style="left:190px;width: 150px;"/>
				</td>
		</tr>
<%-- 		 <%
		}
